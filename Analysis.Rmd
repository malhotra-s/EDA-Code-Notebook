...
logistic_model <- glm(armed_bool ~ race + gender + signs_of_mental_illness, data = all_police_shootings, family = "binomial")
summary(logistic_model)

logistic_model <- glm(is_firearm ~ race + gender + signs_of_mental_illness, data = all_police_shootings, family = "binomial")
...
logistic_model <- glm(armed_bool ~ gender + age + race, data = all_police_shootings, family = "binomial")
summary(logistic_model)
